define(["jquery"],function(i){var n=function(){i(".profession_b dl").mouseover(function(){i(this).css({border:"1px solid #35b558"}),i(this).children("input").css({background:"#35b558",color:"#fff"})}).mouseout(function(){i(this).css({border:""}),i(this).children("input").css({background:"",color:""})}),i(".knowledge_out").each(function(){var n=i(this);n.hover(function(){n.find("dl").css({transform:"rotateY(180deg)"}),n.find(".knowledge_hide").css({transform:"rotateY(0deg)"})},function(){n.find("dl").css({transform:"rotateY(0deg)"}),n.find(".knowledge_hide").css({transform:"rotateY(180deg)"})})}),i(".fine_b dl").mouseover(function(){i(this).css({border:"1px solid #35b558"}),i(this).children("div").show()}).mouseout(function(){i(this).css({border:""}),i(this).children("div").hide()}),i(".fine_hide p").mouseover(function(){i(this).css({color:"#35b558"})}).mouseout(function(){i(this).css({color:""})}),i(".fine_hide input").mouseover(function(){i(this).css({background:"#48D870"})}).mouseout(function(){i(this).css({background:""})});var n;i(".wiki_l dt").mouseover(function(){var t=i(this);n=setTimeout(function(){t.css({background:"#ddd"}),t.children("img").animate({width:"132px",height:"200px"}),t.find(".wiki_hide").show()},300)}).mouseout(function(){clearTimeout(n),i(this).css({background:"#ddd"}),i(this).children("img").animate({width:"142px",height:"200px"}),i(this).find(".wiki_hide").hide()}),i(".wiki_l").mouseover(function(){i(this).css({border:"1px solid #35b558"})}).mouseout(function(){i(this).css({border:""})}),i(".wiki_l").find("ul li,dl dd").mouseover(function(){i(this).css({color:"#35b558"})}).mouseout(function(){i(this).css({color:""})}),i(".cnav_t").find("li").each(function(n){var t=i(this);i(this).mouseover(function(){i(".cnav_lis").removeClass("cnav_lis"),t.addClass("cnav_lis"),i(".canv_li_triangle").removeClass("canv_li_triangle"),t.children("div").addClass("canv_li_triangle"),i(".cnav_show").removeClass("cnav_show"),i(".cnav_b").eq(n).addClass("cnav_show")})}),i(".cnav_out").hover(function(){i(this).children(".cnav_hove").css({display:"block"})},function(){i(this).children(".cnav_hove").css({display:"none"})}),i(".cnav_hove dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})}),i(".strategy_in_r").click(function(){var n=i(".strategy_in").find("img:first"),t=i(".strategy_in").find("img:first").outerWidth(!0);i(".strategy_in").animate({left:-t+"px"},300,function(){i(".strategy_in").css({left:"0px"}).append(n)})}),i(".strategy_in_l").click(function(){var n=i(".strategy_in").find("img:last"),t=i(".strategy_in").find("img:last").outerWidth(!0);i(".strategy_in").animate({left:t+"px"},300,function(){i(".strategy_in").css({left:"0px"}).prepend(n)})}),i(".strategy").hover(function(){i(".strategy_in_l,.strategy_in_r").show()},function(){i(".strategy_in_l,.strategy_in_r").hide()}),i(".media_in_r").click(function(){var n=i(".media_in").find("img:first"),t=i(".media_in").find("img:first").outerWidth(!0);i(".media_in").animate({left:-t+"px"},300,function(){i(".media_in").css({left:"0px"}).append(n)})}),i(".media_in_l").click(function(){var n=i(".media_in").find("img:last"),t=i(".media_in").find("img:last").outerWidth(!0);i(".media_in").animate({left:t+"px"},300,function(){i(".media_in").css({left:"0px"}).prepend(n)})}),i(".media").hover(function(){i(".media_in_l,.media_in_r").show()},function(){i(".media_in_l,.media_in_r").hide()}),i(".cooperation_in_r").click(function(){var n=i(".cooperation_in").find("img:first"),t=i(".cooperation_in").find("img:first").outerWidth(!0);i(".cooperation_in").animate({left:-t+"px"},300,function(){i(".cooperation_in").css({left:"0px"}).append(n)})}),i(".cooperation_in_l").click(function(){var n=i(".cooperation_in").find("img:last"),t=i(".cooperation_in").find("img:last").outerWidth(!0);i(".cooperation_in").animate({left:t+"px"},300,function(){i(".cooperation_in").css({left:"0px"}).prepend(n)})}),i(".cooperation").hover(function(){i(".cooperation_in_l,.cooperation_in_r").show()},function(){i(".cooperation_in_l,.cooperation_in_r").hide()})};return n});
define(["jquery"],function(i){var e=function(){function e(){t++,t==_&&(i(".article_in").css({left:0}),t=1),i(".article_in").stop().animate({left:560*-t},500),t==_-1?i(".article_in_3 li").eq(0).addClass("on").siblings().removeClass("on"):i(".article_in_3 li").eq(t).addClass("on").siblings().removeClass("on")}function c(){t--,t==-1&&(i(".article_in").css({left:560*-(_-1)}),t=_-2),i(".article_in").stop().animate({left:560*-t},500),t==_-1?i(".article_in_3 li").eq(0).addClass("on").siblings().removeClass("on"):i(".article_in_3 li").eq(t).addClass("on").siblings().removeClass("on")}i(".article_l li").each(function(){i(".article_l li").mouseover(function(){i(this).css({borderLeft:"2px solid #35b558",borderTop:"1px solid #ddd",borderBottom:"1px solid #ddd",color:"#35b558",background:"#fff",borderRight:"#fff"}),i(this).children("div").show()}).mouseout(function(){i(this).css({borderLeft:"",borderTop:"",borderBottom:"",color:"",background:"#fff",borderRight:""}),i(this).children("div").hide()})}),i(".article_r_1 P").mouseover(function(){i(this).css({color:"#35b558"}),i(".article_r_1 P").eq(0).css({color:""}),i(".article_r_1 P").eq(1).css({color:"#ff1c1c"})}).mouseout(function(){i(this).css({color:""})}),i(".article_r_3 ul li").each(function(e){var c=i(this);e<4&&c.hover(function(){i(".article_r_hide").css({display:"block"}),i(".article_r_hide4").removeClass("article_r_hide4"),i(".article_r_hide1 span").eq(e).addClass("article_r_hide4"),i(".article_r_hide3").removeClass("article_r_hide3"),i(".article_r_hide2").eq(e).addClass("article_r_hide3")},function(){})}),i(".article_r_hide1").find("span").each(function(e){var c=i(this);i(this).hover(function(){i(".article_r_hide4").removeClass("article_r_hide4"),i(this).addClass("article_r_hide4"),i(".article_r_hide3").removeClass("article_r_hide3"),i(".article_r_hide2").eq(e).addClass("article_r_hide3"),c.parents(".article_r_hide").css({display:"block"})},function(){c.parents(".article_r_hide").css({display:"none"})})}),i(".article_r_hide2").mouseover(function(){i(this).parents(".article_r_hide").css({display:"block"})}).mouseout(function(){i(this).parents(".article_r_hide").css({display:"none"})});var r=i(".article_in img").first().clone(),t=0;i(".article_in").append(r);for(var _=i(".article_in img").size(),l=0;l<_-1;l++)i(".article_in_3").append("<li></li>");i(".article_in_3 li").first().addClass("on"),i(".article_in_1").click(function(){c()}),i(".article_in_2").click(function(){e()}),i(".article_in_3 li").click(function(){var e=i(this).index();t=e,i(this).addClass("on").siblings().removeClass("on"),i(".article_in").stop().animate({left:560*-e},500)});var n=setInterval(function(){c()},2e3);i(".article_c_1_1").hover(function(){clearInterval(n)},function(){n=setInterval(function(){c()},2e3)}),i(".article_c_1_1").hover(function(){i(".article_in_1,.article_in_2").css({display:"block"})},function(){i(".article_in_1,.article_in_2").css({display:"none"})}),i(".article_c_1_2_in_r").click(function(){var e=i(".article_c_1_2_in").find("dl:first"),c=i(".article_c_1_2_in").find("dl:first").outerWidth(!0);i(".article_c_1_2_in").animate({left:-c+"px"},300,function(){i(".article_c_1_2_in").css({left:"0px"}).append(e)})}),i(".article_c_1_2_in_l").click(function(){var e=i(".article_c_1_2_in").find("dl:last"),c=i(".article_c_1_2_in").find("dl:last").outerWidth(!0);i(".article_c_1_2_in").animate({left:c+"px"},300,function(){i(".article_c_1_2_in").css({left:"0px"}).prepend(e)})}),i(".article_c_1_2").hover(function(){i(".article_c_1_2_in_l,.article_c_1_2_in_r").show()},function(){i(".article_c_1_2_in_l,.article_c_1_2_in_r").hide()}),i(".article_c_1_2 dl dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})}),i(".profession_b dl dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})})};return e});
...
define(["jquery"],function(o){var n=function(){o(".footer_b").find("li").hover(function(){o(this).css({color:"#35b558"})},function(){o(this).css({color:""})}),o(".footer_r_2 p,.footer_r_4 p").hover(function(){o(this).css({color:"#35b558"})},function(){o(this).css({color:""})})};return n});
define(["jquery"],function(o){var s=function(){o(".logo_l_3").find("li").mouseover(function(){o(this).css("background","#ddd")}).mouseout(function(){o(this).css("background","#eee")}),o(".logo_l_2,.logo_l_4").mouseover(function(){o(".logo_l_2").css("background","#35b558"),o(".logo_l_4 img").attr("src","images/search1.png")}).mouseout(function(){o(".logo_l_2").css("background","#fff"),o(".logo_l_4 img").attr("src","images/search.png")}),o(".logo_l_1").focus(function(){o(".logo_l_3").hide(),o(".logo_l_2").css("background","#35b558"),o(".logo_l_4 img").attr("src","images/search1.png")}).blur(function(){o(".logo_l_3").show(),o(".logo_l_2").css("background",""),o(".logo_l_4 img").attr("src","images/search.png")}),o(".logo_r_3,.logo_r_h").mouseover(function(){o(".logo_r_3 img").css({transform:"rotate(180deg)"}),o(".logo_r_h").show()}).mouseout(function(){o(".logo_r_3 img").css({transform:"rotate(0deg)"}),o(".logo_r_h").hide()}),o(".logo_r_h li").each(function(){o(".logo_r_h li").mouseover(function(){o(this).css({background:"#eee",color:"#35b558"})}),o(".logo_r_h li").mouseout(function(){o(this).css({background:"#fff",color:"#999"})})})};return s});
...
define(["jquery"],function(i){var o=function(){function o(){c++,c==r&&(i(".article_in").css({left:0}),c=1),i(".article_in").stop().animate({left:560*-c},500),c==r-1?i(".article_in_3 li").eq(0).addClass("on").siblings().removeClass("on"):i(".article_in_3 li").eq(c).addClass("on").siblings().removeClass("on")}function n(){c--,c==-1&&(i(".article_in").css({left:560*-(r-1)}),c=r-2),i(".article_in").stop().animate({left:560*-c},500),c==r-1?i(".article_in_3 li").eq(0).addClass("on").siblings().removeClass("on"):i(".article_in_3 li").eq(c).addClass("on").siblings().removeClass("on")}i(".logo_l_3").find("li").mouseover(function(){i(this).css("background","#ddd")}).mouseout(function(){i(this).css("background","#eee")}),i(".logo_l_2,.logo_l_4").mouseover(function(){i(".logo_l_2").css("background","#35b558"),i(".logo_l_4 img").attr("src","images/search1.png")}).mouseout(function(){i(".logo_l_2").css("background","#fff"),i(".logo_l_4 img").attr("src","images/search.png")}),i(".logo_l_1").focus(function(){i(".logo_l_3").hide(),i(".logo_l_2").css("background","#35b558"),i(".logo_l_4 img").attr("src","images/search1.png")}).blur(function(){i(".logo_l_3").show(),i(".logo_l_2").css("background",""),i(".logo_l_4 img").attr("src","images/search.png")}),i(".logo_r_3,.logo_r_h").mouseover(function(){i(".logo_r_3 img").css({transform:"rotate(180deg)"}),i(".logo_r_h").show()}).mouseout(function(){i(".logo_r_3 img").css({transform:"rotate(0deg)"}),i(".logo_r_h").hide()}),i(".logo_r_h li").each(function(){i(".logo_r_h li").mouseover(function(){i(this).css({background:"#eee",color:"#35b558"})}),i(".logo_r_h li").mouseout(function(){i(this).css({background:"#fff",color:"#999"})})}),i(".nav_b_1 li,.nav_h").each(function(o){i(this).mouseover(function(){i(this).css("color","#35b558"),i(".nav_h").show(),i(".nav_h ul").eq(o).css({background:"#eee"}),i(".triangle").eq(o).css({display:"block"})}).mouseout(function(){i(this).css("color",""),i(".nav_h").hide(),i(".nav_h ul").eq(o).css({background:""}),i(".triangle").eq(o).css({display:""})})}),i(".nav_h li").hover(function(){i(this).parent().css({background:"#eee"})},function(){i(this).parent().css({background:""})}),i(".nav_h ul").hover(function(){i(this).css({background:"#eee"}),i(this).children("div").css({display:"block"})},function(){i(this).css({background:""}),i(this).children("div").css({display:""})}),i(".nav_b_2 li").mouseover(function(){i(this).css("color","#35b558")}).mouseout(function(){i(this).css("color","")}),i(".article_l li").each(function(){i(".article_l li").mouseover(function(){i(this).css({borderLeft:"2px solid #35b558",borderTop:"1px solid #ddd",borderBottom:"1px solid #ddd",color:"#35b558",background:"#fff",borderRight:"#fff"}),i(this).children("div").show()}).mouseout(function(){i(this).css({borderLeft:"",borderTop:"",borderBottom:"",color:"",background:"#fff",borderRight:""}),i(this).children("div").hide()})}),i(".article_r_1 P").mouseover(function(){i(this).css({color:"#35b558"}),i(".article_r_1 P").eq(0).css({color:""}),i(".article_r_1 P").eq(1).css({color:"#ff1c1c"})}).mouseout(function(){i(this).css({color:""})}),i(".profession_b dl").mouseover(function(){i(this).css({border:"1px solid #35b558"}),i(this).children("input").css({background:"#35b558",color:"#fff"})}).mouseout(function(){i(this).css({border:""}),i(this).children("input").css({background:"",color:""})});var e;i(".knowledge_b dl").mouseover(function(){var o=i(this);e=setTimeout(function(){o.children("div").show()},500)}).mouseout(function(){clearTimeout(e),i(this).children("div").hide()}),i(".fine_b dl").mouseover(function(){i(this).css({border:"1px solid #35b558"}),i(this).children("div").show()}).mouseout(function(){i(this).css({border:""}),i(this).children("div").hide()}),i(".fine_hide p").mouseover(function(){i(this).css({color:"#35b558"})}).mouseout(function(){i(this).css({color:""})}),i(".fine_hide input").mouseover(function(){i(this).css({background:"#48D870"})}).mouseout(function(){i(this).css({background:""})});var t;i(".wiki_l dt").mouseover(function(){var o=i(this);t=setTimeout(function(){o.css({background:"#ddd"}),o.children("img").animate({width:"132px",height:"200px"})},300)}).mouseout(function(){clearTimeout(t),i(this).css({background:"#fff"}),i(this).children("img").animate({width:"142px",height:"200px"})}),i(".wiki_l").mouseover(function(){i(this).css({border:"1px solid #35b558"})}).mouseout(function(){i(this).css({border:""})}),i(".wiki_l").find("ul li,dl dd").mouseover(function(){i(this).css({color:"#35b558"})}).mouseout(function(){i(this).css({color:""})}),i(".cnav_t").find("li").each(function(o){var n=i(this);i(this).mouseover(function(){i(".cnav_lis").removeClass("cnav_lis"),n.addClass("cnav_lis"),i(".canv_li_triangle").removeClass("canv_li_triangle"),n.children("div").addClass("canv_li_triangle"),i(".cnav_show").removeClass("cnav_show"),i(".cnav_b").eq(o).addClass("cnav_show")})}),i(".cnav_out").hover(function(){i(this).children(".cnav_hove").css({display:"block"}).slideDown(1e3)},function(){i(this).children(".cnav_hove").css({display:"none"})}),i(".cnav_hove dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})}),i(".article_r_3 ul li").each(function(o){var n=i(this);o<4&&n.hover(function(){i(".article_r_hide").css({display:"block"}),i(".article_r_hide4").removeClass("article_r_hide4"),i(".article_r_hide1 span").eq(o).addClass("article_r_hide4"),i(".article_r_hide3").removeClass("article_r_hide3"),i(".article_r_hide2").eq(o).addClass("article_r_hide3")},function(){})}),i(".article_r_hide1").find("span").each(function(o){var n=i(this);i(this).hover(function(){i(".article_r_hide4").removeClass("article_r_hide4"),i(this).addClass("article_r_hide4"),i(".article_r_hide3").removeClass("article_r_hide3"),i(".article_r_hide2").eq(o).addClass("article_r_hide3"),n.parents(".article_r_hide").css({display:"block"})},function(){n.parents(".article_r_hide").css({display:"none"})})}),i(".article_r_hide2").mouseover(function(){i(this).parents(".article_r_hide").css({display:"block"})}).mouseout(function(){i(this).parents(".article_r_hide").css({display:"none"})}),i(".footer_b").find("li").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})}),i(".footer_r_2 p,.footer_r_4 p").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})});var s=i(".article_in img").first().clone(),c=0;i(".article_in").append(s);for(var r=i(".article_in img").size(),l=0;l<r-1;l++)i(".article_in_3").append("<li></li>");i(".article_in_3 li").first().addClass("on"),i(".article_in_1").click(function(){n()}),i(".article_in_2").click(function(){o()}),i(".article_in_3 li").click(function(){var o=i(this).index();c=o,i(this).addClass("on").siblings().removeClass("on"),i(".article_in").stop().animate({left:560*-o},500)});var _=setInterval(function(){n()},2e3);i(".article_c_1_1").hover(function(){clearInterval(_)},function(){_=setInterval(function(){n()},2e3)}),i(".article_c_1_1").hover(function(){i(".article_in_1,.article_in_2").css({display:"block"})},function(){i(".article_in_1,.article_in_2").css({display:"none"})}),i(".strategy_in_r").click(function(){var o=i(".strategy_in").find("img:first"),n=i(".strategy_in").find("img:first").outerWidth(!0);i(".strategy_in").animate({left:-n+"px"},300,function(){i(".strategy_in").css({left:"0px"}).append(o)})}),i(".strategy_in_l").click(function(){var o=i(".strategy_in").find("img:last"),n=i(".strategy_in").find("img:last").outerWidth(!0);i(".strategy_in").animate({left:n+"px"},300,function(){i(".strategy_in").css({left:"0px"}).prepend(o)})}),i(".strategy").hover(function(){i(".strategy_in_l,.strategy_in_r").show()},function(){i(".strategy_in_l,.strategy_in_r").hide()}),i(".media_in_r").click(function(){var o=i(".media_in").find("img:first"),n=i(".media_in").find("img:first").outerWidth(!0);i(".media_in").animate({left:-n+"px"},300,function(){i(".media_in").css({left:"0px"}).append(o)})}),i(".media_in_l").click(function(){var o=i(".media_in").find("img:last"),n=i(".media_in").find("img:last").outerWidth(!0);i(".media_in").animate({left:n+"px"},300,function(){i(".media_in").css({left:"0px"}).prepend(o)})}),i(".media").hover(function(){i(".media_in_l,.media_in_r").show()},function(){i(".media_in_l,.media_in_r").hide()}),i(".cooperation_in_r").click(function(){var o=i(".cooperation_in").find("img:first"),n=i(".cooperation_in").find("img:first").outerWidth(!0);i(".cooperation_in").animate({left:-n+"px"},300,function(){i(".cooperation_in").css({left:"0px"}).append(o)})}),i(".cooperation_in_l").click(function(){var o=i(".cooperation_in").find("img:last"),n=i(".cooperation_in").find("img:last").outerWidth(!0);i(".cooperation_in").animate({left:n+"px"},300,function(){i(".cooperation_in").css({left:"0px"}).prepend(o)})}),i(".cooperation").hover(function(){i(".cooperation_in_l,.cooperation_in_r").show()},function(){i(".cooperation_in_l,.cooperation_in_r").hide()}),i(".article_c_1_2_in_r").click(function(){var o=i(".article_c_1_2_in").find("dl:first"),n=i(".article_c_1_2_in").find("dl:first").outerWidth(!0);i(".article_c_1_2_in").animate({left:-n+"px"},300,function(){i(".article_c_1_2_in").css({left:"0px"}).append(o)})}),i(".article_c_1_2_in_l").click(function(){var o=i(".article_c_1_2_in").find("dl:last"),n=i(".article_c_1_2_in").find("dl:last").outerWidth(!0);i(".article_c_1_2_in").animate({left:n+"px"},300,function(){i(".article_c_1_2_in").css({left:"0px"}).prepend(o)})}),i(".article_c_1_2").hover(function(){i(".article_c_1_2_in_l,.article_c_1_2_in_r").show()},function(){i(".article_c_1_2_in_l,.article_c_1_2_in_r").hide()}),i(".article_c_1_2 dl dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})}),i(".profession_b dl dd").hover(function(){i(this).css({color:"#35b558"})},function(){i(this).css({color:""})})};return o});
...
require.config({paths:{jquery:"jquery-2.1.4"}}),require(["header"],function(e){e()}),require(["nav"],function(e){e()}),require(["banner"],function(e){e()}),require(["article"],function(e){e()}),require(["footer"],function(e){e()});
define(["jquery"],function(s){var n=function(){s(".nav_b_1 li,.nav_h").each(function(n){s(this).mouseover(function(){s(this).css("color","#35b558"),s(".nav_h").show(),s(".nav_h ul").eq(n).css({background:"#eee"}),s(".triangle").eq(n).css({display:"block"})}).mouseout(function(){s(this).css("color",""),s(".nav_h").hide(),s(".nav_h ul").eq(n).css({background:""}),s(".triangle").eq(n).css({display:""})})}),s(".nav_h li").hover(function(){s(this).parent().css({background:"#eee"})},function(){s(this).parent().css({background:""})}),s(".nav_h ul").hover(function(){s(this).css({background:"#eee"}),s(this).children("div").css({display:"block"})},function(){s(this).css({background:""}),s(this).children("div").css({display:""})}),s(".nav_b_2 li").mouseover(function(){s(this).css("color","#35b558")}).mouseout(function(){s(this).css("color","")})};return n});
